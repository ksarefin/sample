...
<form name="frm" method="post" action="{$self}/htmlSave/form_id/{$form_id|make_id}/html_id/{$html_id|make_id}" enctype="multipart/form-data">
...
<ul class="btnList">
<li><input type="button" name="back" id="back" class="back btnWhiteB" value="戻る" onClick="window.location='{$wpcms_path}/{$access_name}/form_html/'" /></li>
