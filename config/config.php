 ...
 * @package    ActiveIR
 * @author     Arefin Tuhin
 * @version    SVN: Id: profile 2692 2011/05/13-16:46:45 fabien 
 * 
 *File content
     config.php
 *     
 */
 ...
 class Configuration extends BaseClass {
 	...
 	/**
 	 * ini wpcms path instance
 	 */
 	protected $wpcms_path;
 	...
 	function __construct(){
 		...
 		$this->wpcms_path	= $GLOBALS['server_info']['wpcms_path'];
 		...
 		$this->viewAssign('access_name', 'wpform/'.$this->access_name);
